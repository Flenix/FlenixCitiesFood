...
public class ItemFoodFish extends ItemFood implements IFlenixFoods {
	...
	public ItemFoodFish(double feed, float sat, boolean wolf, int time, String name, float uc, float c, float b, boolean poison, int bone, boolean steak, int prefCookType) {
