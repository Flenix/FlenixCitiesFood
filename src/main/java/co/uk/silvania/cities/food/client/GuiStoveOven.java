...
public class GuiStoveOven extends GuiContainer {
	...
	public void initGui() {
		super.initGui();
		buttonList.add(new InvisibleButton(1, guiLeft + 58, guiTop + 9, 10, 16, "-"));
		...
		buttonList.add(new InvisibleButton(4, guiLeft + 134, guiTop + 9, 10, 16, "+"));
		buttonList.add(new InvisibleButton(5, guiLeft + 58, guiTop + 117, 10, 16, "-"));
		...
		buttonList.add(new InvisibleButton(8, guiLeft + 134, guiTop + 117, 10, 16, "+"));
	}
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		...
		fontRendererObj.drawString("" + hob1Temp + "c", 62, 13, 4210752);
		fontRendererObj.drawString("" + hob2Temp + "c", 109, 13, 4210752);
		fontRendererObj.drawString("" + hob3Temp + "c", 62, 121, 4210752);
		fontRendererObj.drawString("" + hob4Temp + "c", 109, 121, 4210752);
	}
