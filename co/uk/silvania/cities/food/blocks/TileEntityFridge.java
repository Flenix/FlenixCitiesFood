...
public class TileEntityFridge extends TileEntityChest implements IInventory
{
    ...
    public void readFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        for (int i = 0; i < nbttaglist.tagCount(); ++i)
        {
            ...
            if (j >= 0 && j < this.fridgeContents.length)
            {
                this.fridgeContents[j] = ItemStack.loadItemStackFromNBT(nbttagcompound1);
            }
        }
    }
    ...
    public void writeToNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        for (int i = 0; i < this.fridgeContents.length; ++i)
        {
            if (this.fridgeContents[i] != null)
            {
                NBTTagCompound nbttagcompound1 = new NBTTagCompound();
                nbttagcompound1.setByte("Slot", (byte)i);
                this.fridgeContents[i].writeToNBT(nbttagcompound1);
