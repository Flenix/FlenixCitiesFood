...
public class FCF_Items {
	...
	public static void initUtensils() {
		...
		saucepanSmall = new ItemHobUtensil(config.saucepanSmallID, 4).setUnlocalizedName("saucepanSmall");
		saucepanLarge = new ItemHobUtensil(config.saucepanLargeID, 4).setUnlocalizedName("saucepanLarge");
		fryingPan = new ItemHobUtensil(config.fryingPanID, 2).setUnlocalizedName("fryingPan");
		wokItem = new ItemHobUtensil(config.wokItemID, 2).setUnlocalizedName("wokItem");
